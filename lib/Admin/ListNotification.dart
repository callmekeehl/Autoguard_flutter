  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Liste des Notifications', style: TextStyle(color: Colors.white),),
      ...
      body: isLoading
        ...
        itemBuilder: (context, index) {
          ...
          final String date = notification['dateEnvoi'] ?? 'Date inconnue';
          final String message = notification['message'] ?? 'Message non disponible';
          ...
          return ListTile(
            ...
            title: Text(date),
            subtitle: Text(message.substring(0, message.length > 50 ? 50 : message.length) + '...'),
            onTap: () {
